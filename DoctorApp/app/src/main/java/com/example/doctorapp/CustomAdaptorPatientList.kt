...
class CustomAdaptorPatientList(var context: Context,var patient:ArrayList<PatientInfo>) :BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        var current_patient=getItem(position) as PatientInfo
    ...
    fun updateList(list:ArrayList<PatientInfo>){
        patient.clear()
        list.addAll(list)
